      ...
      <div className="sidenav-contanier">
        <div className="sidenav-header">
          ...
          <a className="close-icon">
            <img src="/images/partials/close-icon.png" alt="close-cta" />{" "}
          </a>
        </div>
        <div className="mobile-group-list">
          <a href="#">
            <div>
              <h2 className="mobile-header all-category">About Us</h2>
            </div>
          </a>
          <a href="#">
            <div>
              <h2 className="mobile-header all-category">Collections</h2>
            </div>
          </a>
          <a href="#">
            <div>
              <h2 className="mobile-header all-category">Blog Post</h2>
            </div>
          </a>
          ...
          <div className="tab">
            <div className="tab-header" data-target="watch">
              <div>
                <h2 className="mobile-header">Watch</h2>
              </div>
