  ...
  return (
    <div className="w-[17.5rem] border-separate hidden lg:inline-block  border-spacing-4 border">
      <div className="bg-accent/20">
        <tr>
          <th className="font-[600] text-[16px]">Filter By</th>
        </tr>
      </div>
      ...
      <div className="px-4 py-2 leading-9 border-b">
        ...
        <div className="flex gap-2 mb-2">
          <span className="text-[18px]">$</span><input type="text" placeholder="From" className="w-20 focus:outline-none px-2 border-accent border rounded-full py-1" />
          <span className="text-[18px]">$</span><input type="text" placeholder="To" className="w-20 focus:outline-none px-2 border-accent border rounded-full py-1 " />
        </div>
      </div>
