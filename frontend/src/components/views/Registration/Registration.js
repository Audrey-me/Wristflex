...
export default function Registration({inner,setInner}) {
  ...
  return (
    ...
    <div style={{display:"none"}}   className='login-contanier1  '>
        ...
        <h2 style={{fontSize: "1.8rem",color:"#232323!important"}}>Login</h2>
 ...
 <h2 style={{fontSize: "1.8rem",color:"#232323!important"}}>Create Account</h2>
 <form method="post" action="/account/login" id="customer_login" className= "customer_login" auto-charset="UTF-8" >
        <div className="field"> 
 ...
 <button style={{marginTop:"30px"}} className="signin-btn flash-button">Create</button>
...
<h2 style={{fontSize: "1.8rem",color:"#232323!important"}}>Reset your Password</h2>
