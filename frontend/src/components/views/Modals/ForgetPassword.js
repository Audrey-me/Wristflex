      ...
      <div className='modal-body login_form_container'>
        <div className='modal-text'>
          ...
          <form method="post" action="/account/login" id="customer_login" className="customer_login" auto-charset="UTF-8" >
            <div className="field">
              <input type="email" name="customer[user_email]" id="CustomerEmail" className='reset_field' autoComplete="email" autoCorrect="off" autoCapitalize="off" placeholder="Email" />
            </div>
